            ...
            <SidebarContent>
                <SidebarGroup>
                    <div className="px-4 py-2">
                        <Button asChild variant="outline" className="w-full justify-start bg-transparent text-black dark:text-white border-gray-200 dark:border-[#4E4F60] hover:bg-[#f8f5f2] dark:hover:bg-[#444654]">
                    ...
                    <SidebarGroupLabel className="text-black dark:text-white">Recent Chats</SidebarGroupLabel>
                    <SidebarMenu>
                        {loadingChats ? (
                            <div className="px-4 py-2 text-sm text-black/70 dark:text-white/70">Loading...</div>
                        ) : chats.length > 0 ? (
                            chats.map((chat) => (
                            ...
                            <div className="px-4 py-2 text-sm text-black/70 dark:text-white/70">No chats yet</div>
                        )}
                    </SidebarMenu>
                </SidebarGroup>
                <SidebarSeparator className="bg-gray-200 dark:bg-[#4E4F60]" />
                <SidebarGroup>
                    <SidebarGroupLabel className="text-black dark:text-white">Integrations</SidebarGroupLabel>
                    <div className="px-4 py-2">
                        <AuthKitButton />
                    </div>
                </SidebarGroup>
                ...
                <div className="flex items-center justify-between p-4">
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="bg-[#eae2d8] dark:bg-[#343541] text-black dark:text-white border-gray-200 dark:border-none">
                            <DropdownMenuItem asChild className="hover:bg-[#f8f5f2] dark:hover:bg-[#444654] focus:bg-[#f8f5f2] dark:focus:bg-[#444654] cursor-pointer">
                            ...
                            <DropdownMenuItem onClick={handleClearChats} className="hover:bg-[#f8f5f2] dark:hover:bg-[#444654] focus:bg-[#f8f5f2] dark:focus:bg-[#444654] cursor-pointer">
                                Clear all chats
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
